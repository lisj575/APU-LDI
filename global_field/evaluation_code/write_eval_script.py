...
def write_eval_script(args):
    ...
    if args.dataset == 'pu1k':
        mesh_dir = os.path.join(args.dataset_path, "PU1K/test/original_meshes/")
        script_name = "eval_pu1k.sh"
    else:
        mesh_dir = os.path.join(args.dataset_path, "PU-GAN/test/")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_path', default='../../local_distance_indicator/data', type=str, help='the original mesh path')
